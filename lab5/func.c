...
Image *MagnitudeImage(Image *image) {
    ...
    Image *outimage;
    outimage = CreateNewImage(image, image->Height, image->Width, "#Magnitude Reconstruction");
    tempin = image->data;
...
Image *PhaseAngleImage(Image *image) {
    unsigned char *tempin, *tempout;
    Image *outimage;
    outimage = CreateNewImage(image, image->Height, image->Width, "#Phase Angle Reconstruction");
    tempin = image->data;
    tempout = outimage->data;
    int matrixWidth = image->Width;
    int matrixHeight = image->Height;
...
Image *DFTImage(Image *image) {
    unsigned char *tempin, *tempout;
    Image *outimage;
    outimage = CreateNewImage(image, image->Height, image->Width, "#DFT Transform");
    tempin = image->data;
    tempout = outimage->data;
    int matrixWidth = image->Width;
    int matrixHeight = image->Height;
